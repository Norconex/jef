 ...
 */
package com.norconex.jef5.session.store;
...
public interface IJobSessionStore {
     ...
     */
    JobSession read(String suiteName, String jobId)
            throws IOException;
    /**
...
//     */
//    void backup(String suiteName, String jobId, LocalDateTime backupDate)
//            throws IOException;
    /**
     * Backups job progress.  A backed-up job progress can no longer be
     * obtained using the {@link #read(String, String)} method.
     ...
     * @throws IOException problem backing-up job progress
     */
    void backup(String suiteName, LocalDateTime backupDate)
            throws IOException;
     ...
     */
    LocalDateTime touch(String suiteName, String jobId) throws IOException;
}
